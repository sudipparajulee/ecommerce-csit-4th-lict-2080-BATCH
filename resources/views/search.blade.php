...
@section('content')
    <div class="px-20 py-10">
        <h2 class="font-bold text-2xl border-l-4 border-blue-600 pl-2">Search Result for - {{request('search')}}</h2>
        <div class="grid grid-cols-4 gap-4 mt-5">
            ...
            <div class="col-span-4 text-center">
                <p class="text-gray-400 text-4xl">No products found for "{{request('search')}}"</p>
            </div>
            @endforelse
        </div>
    </div>
