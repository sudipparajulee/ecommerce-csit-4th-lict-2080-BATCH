    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('email') }}">
            </div>
            <div class="mb-6">
